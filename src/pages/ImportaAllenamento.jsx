            ...
            <div style={{background:'#EAF3DE',border:'0.5px solid #3B6D11',borderRadius:10,padding:'12px 16px',marginBottom:14,display:'flex',alignItems:'center',gap:12}}>
              ...
              <div>
                ...
                <div style={{fontSize:12,color:'#3B6D11',opacity:0.8}}>
                  ...
                  {parsedPlan.diet_type && parsedPlan.diet_type !== 'lineare' && ` · ${{'on_off':'ON/OFF','onde':'Ad onde','reverse':'Reverse diet','ciclico':'Deficit/Surplus ciclico','refeed':'Refeed'}[parsedPlan.diet_type] || parsedPlan.diet_type}`}
