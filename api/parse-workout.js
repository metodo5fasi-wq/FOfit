...
- "progression_type": "linear" se nel testo c'è una progressione di carico (es. "+2.5kg/sett", "progressione lineare", "aumenta 5kg ogni settimana"), altrimenti "none".
- "progression_start_kg": il carico iniziale della progressione se specificato (numero), altrimenti null.
- "progression_increment_kg": l'incremento in kg per settimana (numero), default 2.5 se non specificato.
- "progression_weeks": numero di settimane della progressione, default 4 se non specificato.
