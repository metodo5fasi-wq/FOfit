...
- Quando un alimento ha alternative separate da "/" (es. "200g Petto di pollo / 200g Petto di tacchino / 240g Pesce Bianco"), metti la PRIMA opzione come alimento principale e le successive (massimo 3) nell'array "opzioni" di quell'alimento, stimando kcal/proteine/carboidrati/grassi per ciascuna in base a valori nutrizionali standard.
- "alternative" (a livello di pasto, es. "Pranzo Alternativa1)", "Alternativa Cena 2)") sono pasti sostitutivi interi — diverso dalle scelte "/" dentro lo stesso pasto.
- Stima sempre kcal/proteine/carboidrati/grassi per alimenti e opzioni in base a valori standard per 100g.
- Ometti note di preparazione, modalità d'uso e badge come "[MAX 1 X WEEK]" o "[CONSIGLIATO...]" dal nome alimento.
- Mantieni l'ordine dei pasti come nel testo (Colazione, Spuntino, Pranzo, Spuntino, Cena...).`
